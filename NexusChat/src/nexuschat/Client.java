...
import java.net.*;
import java.io.*;
import static nexuschat.Server.f;
...
public class Client implements ActionListener{
    JTextField text;
    static JPanel a1;     //text display area
    ...
    public Client() {
        ...
        //Profile Picture
        ImageIcon profile_icon = new ImageIcon(ClassLoader.getSystemResource("icons/Roronoa_Zoro.png"));
        ...
        f.setLocation(800,50);        // starting visible location on screen
